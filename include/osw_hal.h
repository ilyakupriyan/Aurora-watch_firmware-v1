...
public:
  ...
  //QMC5883L
  bool hasHMC5883L(void);
  void setupHMC5883L(void);
  int hmc5883_GetAzimuth(void);
  int hmc5883_GetX(void);
  int hmc5883_GetY(void);
  int hmc5883_GetZ(void);
  void hmc5883_setCalibration(int x_min, int x_max, int y_min, int y_max, int z_min, int z_max);
